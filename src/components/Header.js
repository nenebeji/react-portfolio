    ...
    <header>
      ...
      <li className="nav-item">
        <a
          ...
          className={currentPage === 'Home' ? 'nav yellownav' : 'nav-link'}
        >
      ...
      <li className="nav-item">
        <a
          ...
          className={currentPage === 'About' ? 'nav yellownav' : 'nav-link'}
        >
      ...
      <li className="nav-item">
        <a
          ...
          className={currentPage === 'Work' ? 'nav yellownav' : 'nav-link'}
        >
      ...
      <li className="nav-item">
        <a
          ...
          className={currentPage === 'Contact' ? 'nav yellownav' : 'nav-link'}
        >
